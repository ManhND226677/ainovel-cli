...
var planStartContract = llmcontract.Contract{
	...
	Description: "Phán quyết khởi động: chọn người lập kế hoạch (planner) và tạo nội dung tác vụ đầy đủ",
	Schema: schema.Object(
		schema.Property("planner", schema.Enum("Người lập kế hoạch", "architect_long", "architect_short")).Required(),
		schema.Property("task", schema.String("Nhiệm vụ đầy đủ giao cho planner (bao gồm cả các yêu cầu đã được mở rộng)")).Required(),
